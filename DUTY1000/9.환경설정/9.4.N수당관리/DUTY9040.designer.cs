namespace DUTY1000
{
    partial class duty9040
    {
        ...
        private void InitializeComponent()
        {
			...
			this.srTitle1.SRTitleTxt = "N수당관리";
			...
			this.btn_excel.Location = new System.Drawing.Point(937, 11);
			...
			this.btn_e_up.Location = new System.Drawing.Point(1018, 11);
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "N수당차감";
			this.gridColumn3.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn3.FieldName = "MINUS_NAMT";
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "N수당지급";
			this.gridColumn1.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn1.FieldName = "PLUS_NAMT";
			...
			this.pivotGridField5.Caption = "N수당차감";
			...
			this.pivotGridField5.FieldName = "MINUS_NAMT";
			...
			this.pivotGridField6.Caption = "N수당지급";
			...
			this.pivotGridField6.FieldName = "PLUS_NAMT";
