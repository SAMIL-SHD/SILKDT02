namespace DUTY1000
{
    partial class duty2023
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(duty2023));
			...
			this.col_name.Caption = "근무시간";
			this.col_name.FieldName = "TIME_REMK";
			...
			this.col_name.VisibleIndex = 7;
			this.col_name.Width = 172;
			// 
			// btn_exit
			// 
			...
			this.srPanel1.Size = new System.Drawing.Size(750, 46);
			...
			this.srTitle1.SRTitleTxt = "콜 일괄등록";
			...
			this.srPanel3.Location = new System.Drawing.Point(485, 3);
			...
			this.gr_detail.Size = new System.Drawing.Size(750, 636);
			...
			this.grd1.Location = new System.Drawing.Point(2, 191);
			...
			this.grd1.Size = new System.Drawing.Size(746, 443);
            ...
            this.gridColumn3,
            this.col_chk});
			gridFormatRule3.Column = this.col_name;
			...
			gridFormatRule4.Column = this.col_name;
			...
			this.col_code.Caption = "근무일자";
			this.col_code.FieldName = "DATE_NM";
			...
			// gridColumn2
			// 
			this.gridColumn2.AppearanceCell.BackColor = System.Drawing.Color.WhiteSmoke;
			...
			this.gridColumn4.Caption = "콜횟수(주)";
			this.gridColumn4.FieldName = "CALL_CNT1";
			...
			this.gridColumn5.Caption = "콜횟수(야)";
			this.gridColumn5.FieldName = "CALL_CNT2";
			...
			this.gridColumn6.Caption = "콜시간(주)";
			this.gridColumn6.FieldName = "CALL_TIME1";
			...
			this.gridColumn9.Caption = "콜시간(야)";
			this.gridColumn9.FieldName = "CALL_TIME2";
			...
			this.srPanel2.Controls.Add(this.sl_dept);
			this.srPanel2.Controls.Add(this.srLabel7);
			this.srPanel2.Controls.Add(this.srLabel2);
			this.srPanel2.Controls.Add(this.txt_time);
			this.srPanel2.Controls.Add(this.srLabel5);
			this.srPanel2.Controls.Add(this.srLabel14);
			this.srPanel2.Controls.Add(this.mm_remk);
			this.srPanel2.Controls.Add(this.srLabel4);
			this.srPanel2.Controls.Add(this.txt_cnt1);
			this.srPanel2.Controls.Add(this.txt_ctime1);
			this.srPanel2.Controls.Add(this.srLabel9);
			this.srPanel2.Controls.Add(this.srLabel8);
			this.srPanel2.Controls.Add(this.txt_ctime2);
			this.srPanel2.Controls.Add(this.txt_cnt2);
			...
			this.srPanel2.Size = new System.Drawing.Size(746, 169);
			...
			this.dat_ovdt.Location = new System.Drawing.Point(252, 8);
			...
			this.dat_ovdt.Size = new System.Drawing.Size(107, 22);
			this.dat_ovdt.TabIndex = 557;
			// 
			// sl_dept
			// 
			this.sl_dept.EditValue = "부서선택";
			this.sl_dept.EnterMoveNextControl = true;
			this.sl_dept.Location = new System.Drawing.Point(75, 8);
			...
			this.sl_dept.Size = new System.Drawing.Size(107, 23);
			this.sl_dept.TabIndex = 558;
			// 
			// gridView1
			// 
			...
			this.gridColumn16.Width = 262;
			// 
			// gridColumn17
			// 
			this.gridColumn17.Caption = "명칭";
			...
			this.srLabel7.Location = new System.Drawing.Point(10, 8);
			...
			this.srLabel7.TabIndex = 559;
			this.srLabel7.Text = "근무부서";
			...
			this.srLabel2.Location = new System.Drawing.Point(187, 8);
			...
			this.txt_time.Location = new System.Drawing.Point(75, 86);
			...
			this.srLabel5.Location = new System.Drawing.Point(10, 86);
			...
			this.srLabel14.Location = new System.Drawing.Point(10, 112);
			...
			this.mm_remk.Location = new System.Drawing.Point(74, 112);
			...
			this.mm_remk.Size = new System.Drawing.Size(285, 50);
			this.mm_remk.TabIndex = 548;
			// 
			// srLabel4
			// 
			...
			this.srLabel4.Location = new System.Drawing.Point(10, 34);
			...
			this.txt_cnt1.Location = new System.Drawing.Point(75, 34);
			...
			this.txt_cnt1.TabIndex = 541;
			// 
			// txt_ctime1
			// 
			this.txt_ctime1.EditValue = "";
			this.txt_ctime1.EnterMoveNextControl = true;
			this.txt_ctime1.Location = new System.Drawing.Point(189, 34);
			...
			this.srLabel9.Location = new System.Drawing.Point(124, 60);
			...
			this.srLabel8.Location = new System.Drawing.Point(124, 34);
			...
			this.txt_ctime2.Location = new System.Drawing.Point(189, 60);
			...
			this.txt_ctime2.TabIndex = 544;
			// 
			// txt_cnt2
			// 
			this.txt_cnt2.EditValue = "";
			this.txt_cnt2.EnterMoveNextControl = true;
			this.txt_cnt2.Location = new System.Drawing.Point(75, 60);
			...
			this.srLabel10.Location = new System.Drawing.Point(10, 60);
			...
			this.Text = "duty2023";
			this.Load += new System.EventHandler(this.duty2023_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.duty2023_KeyDown);
