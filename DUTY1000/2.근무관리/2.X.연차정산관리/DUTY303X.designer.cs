namespace DUTY1000
{
    partial class duty303x
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(duty303x));
			...
			this.srTitle1.SRTitleTxt = "연차미사용등록";
			...
			this.srPanel3.Location = new System.Drawing.Point(925, 3);
			...
			this.btn_excel.Location = new System.Drawing.Point(939, 11);
			...
			this.btn_e_up.Location = new System.Drawing.Point(1020, 11);
			...
			this.btn_canc.Location = new System.Drawing.Point(403, 11);
			...
			this.srTabControl1.Size = new System.Drawing.Size(1132, 661);
			...
			this.xtraTabPage1.Size = new System.Drawing.Size(1126, 631);
			...
			this.grd.Size = new System.Drawing.Size(1126, 585);
			...
			this.grdv.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(this.grdv_CellValueChanged);
			this.grdv.CellValueChanging += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(this.grdv_CellValueChanging);
			// 
			// gridColumn2
			// 
			...
			// col_r_name
			// 
			this.col_r_name.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
			this.col_r_name.AppearanceCell.Options.UseBackColor = true;
			...
			this.col_r_name.Width = 121;
			// 
			// gridColumn3
			// 
			this.gridColumn3.Caption = "총개수";
			this.gridColumn3.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn3.FieldName = "YC_T_CNT";
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "전월누적";
			this.gridColumn1.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn1.FieldName = "YC_BF_SUM_CNT";
			...
			// gridColumn5
			// 
			this.gridColumn5.Caption = "당월연차";
			this.gridColumn5.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn5.FieldName = "YC_THIS_YCNT";
			...
			// gridColumn6
			// 
			this.gridColumn6.Caption = "당월반차";
			this.gridColumn6.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn6.FieldName = "YC_THIS_BCNT";
			...
			this.gridColumn9.Caption = "당월누적";
			this.gridColumn9.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn9.FieldName = "YC_NOW_SUM_CNT";
			...
			// gridColumn11
			// 
			this.gridColumn11.AppearanceCell.BackColor = System.Drawing.Color.LightGray;
			this.gridColumn11.AppearanceCell.Options.UseBackColor = true;
			this.gridColumn11.Caption = "남은개수";
			this.gridColumn11.ColumnEdit = this.repositoryItemTextEdit2;
			this.gridColumn11.FieldName = "YC_REMAIN_CNT";
			...
			this.xtraTabPage2.Size = new System.Drawing.Size(1126, 631);
			...
			this.pv_grd.Size = new System.Drawing.Size(1126, 585);
			...
			this.pivotGridField5.Caption = "연차미사용";
			...
			this.pivotGridField5.FieldName = "YC_MI_CNT";
			...
			this.srPanel2.Size = new System.Drawing.Size(1126, 46);
			...
			this.btn_s_canc.Location = new System.Drawing.Point(404, 11);
			...
			this.btn_search.Location = new System.Drawing.Point(323, 11);
