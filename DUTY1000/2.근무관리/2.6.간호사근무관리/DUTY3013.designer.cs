namespace DUTY1000
{
    partial class duty3013
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(duty3013));
			...
			this.grd_e = new DevExpress.XtraGrid.GridControl();
			this.grdv_e = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.grd_e)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.grdv_e)).BeginInit();
			...
			// col_remk
			// 
			this.col_remk.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
			this.col_remk.AppearanceCell.Options.UseBackColor = true;
			this.col_remk.AppearanceCell.Options.UseTextOptions = true;
			this.col_remk.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.col_remk.Caption = "입사일";
			this.col_remk.FieldName = "IPDT";
			...
			this.col_remk.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.col_remk.OptionsColumn.ReadOnly = true;
			this.col_remk.OptionsColumn.TabStop = false;
			...
			this.btn_exit.Location = new System.Drawing.Point(229, 9);
			...
			this.srPanel1.Size = new System.Drawing.Size(621, 46);
			...
			this.srTitle1.Size = new System.Drawing.Size(222, 39);
			this.srTitle1.SRTitleTxt = "밤근무 수당내역";
			...
			this.srPanel3.Location = new System.Drawing.Point(322, 3);
			...
			this.srPanel3.Size = new System.Drawing.Size(296, 40);
			...
			this.btn_excel.Location = new System.Drawing.Point(67, 9);
			...
			this.btn_search.Location = new System.Drawing.Point(6, 9);
			...
			this.btn_save.Location = new System.Drawing.Point(148, 9);
			...
			this.gr_detail.Controls.Add(this.grd_e);
			...
			this.gr_detail.Size = new System.Drawing.Size(621, 641);
			this.gr_detail.TabIndex = 1;
			this.gr_detail.Text = "결재상신";
			// 
			// grd_e
			// 
			this.grd_e.Location = new System.Drawing.Point(12, 196);
			this.grd_e.MainView = this.grdv_e;
			this.grd_e.Name = "grd_e";
			this.grd_e.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemTextEdit5,
            this.repositoryItemTextEdit6,
            this.repositoryItemTextEdit4,
            this.repositoryItemCheckEdit2});
			this.grd_e.Size = new System.Drawing.Size(394, 238);
			this.grd_e.TabIndex = 4;
			this.grd_e.TabStop = false;
			this.grd_e.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.grdv_e});
			this.grd_e.Visible = false;
			// 
			// grdv_e
			// 
			this.grdv_e.Appearance.Empty.BackColor = System.Drawing.Color.WhiteSmoke;
			this.grdv_e.Appearance.Empty.Options.UseBackColor = true;
			this.grdv_e.Appearance.FooterPanel.Font = new System.Drawing.Font("맑은 고딕", 9F);
			this.grdv_e.Appearance.FooterPanel.Options.UseFont = true;
			this.grdv_e.Appearance.HeaderPanel.Font = new System.Drawing.Font("맑은 고딕", 9F, System.Drawing.FontStyle.Bold);
			this.grdv_e.Appearance.HeaderPanel.GradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
			this.grdv_e.Appearance.HeaderPanel.Options.UseFont = true;
			this.grdv_e.Appearance.HeaderPanel.Options.UseTextOptions = true;
			this.grdv_e.Appearance.HeaderPanel.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.grdv_e.Appearance.Row.Font = new System.Drawing.Font("맑은 고딕", 9F);
			this.grdv_e.Appearance.Row.Options.UseFont = true;
			this.grdv_e.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.Simple;
			this.grdv_e.ColumnPanelRowHeight = 35;
			this.grdv_e.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.gridColumn9,
            this.gridColumn6,
            this.gridColumn10,
            this.gridColumn11,
			...
			this.grdv_e.FormatRules.Add(gridFormatRule1);
			this.grdv_e.FormatRules.Add(gridFormatRule2);
			this.grdv_e.GridControl = this.grd_e;
			this.grdv_e.Name = "grdv_e";
			this.grdv_e.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.False;
			this.grdv_e.OptionsClipboard.CopyColumnHeaders = DevExpress.Utils.DefaultBoolean.False;
			this.grdv_e.OptionsEditForm.ActionOnModifiedRowChange = DevExpress.XtraGrid.Views.Grid.EditFormModifiedAction.Save;
			this.grdv_e.OptionsNavigation.EnterMoveNextColumn = true;
			this.grdv_e.OptionsSelection.MultiSelect = true;
			this.grdv_e.OptionsView.AllowCellMerge = true;
			this.grdv_e.OptionsView.ColumnAutoWidth = false;
			this.grdv_e.OptionsView.ShowGroupPanel = false;
			this.grdv_e.RowHeight = 20;
			// 
			// gridColumn9
			// 
			...
			this.gridColumn6.FieldName = "EMBSNAME";
			...
			// gridColumn10
			// 
			this.gridColumn10.Caption = "년차";
			this.gridColumn10.ColumnEdit = this.repositoryItemTextEdit5;
			this.gridColumn10.FieldName = "PAST_YEAR";
			...
			// gridColumn11
			// 
			this.gridColumn11.Caption = "갯수";
			this.gridColumn11.ColumnEdit = this.repositoryItemTextEdit6;
			this.gridColumn11.FieldName = "MM_CNT3";
			...
			// gridColumn14
			// 
			this.gridColumn14.Caption = "비용";
			this.gridColumn14.ColumnEdit = this.repositoryItemTextEdit4;
			this.gridColumn14.DisplayFormat.FormatString = "{0:#,###}";
			this.gridColumn14.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.gridColumn14.FieldName = "SD_AMT";
            ...
            this.grdv1});
			this.grd1.EditorKeyDown += new System.Windows.Forms.KeyEventHandler(this.grd1_EditorKeyDown);
			// 
			// grdv1
			// 
			...
			this.gridColumn5.FieldName = "SAWON_NO";
			...
			this.col_code.Caption = "갯수";
			this.col_code.ColumnEdit = this.repositoryItemTextEdit2;
			this.col_code.DisplayFormat.FormatString = "{0:#,###}";
			this.col_code.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
			this.col_code.FieldName = "MM_CNT3";
			...
			this.col_code.VisibleIndex = 4;
			this.col_code.Width = 43;
			// 
			...
			// col_chk
			// 
			this.col_chk.AppearanceCell.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(224)))), ((int)(((byte)(192)))));
			this.col_chk.AppearanceCell.Options.UseBackColor = true;
			...
			this.col_chk.OptionsColumn.FixedWidth = true;
			this.col_chk.OptionsColumn.TabStop = false;
			...
			// srPanel2
			// 
			this.srPanel2.Controls.Add(this.btn_e_up);
			...
			this.btn_e_up.Location = new System.Drawing.Point(509, 9);
			...
			this.ClientSize = new System.Drawing.Size(621, 687);
			this.Controls.Add(this.gr_detail);
			this.Controls.Add(this.srPanel1);
			this.Name = "duty3013";
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "duty3012";
			this.Load += new System.EventHandler(this.duty3012_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.duty3012_KeyDown);
			...
			((System.ComponentModel.ISupportInitialize)(this.grd_e)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.grdv_e)).EndInit();
		...
		private DevExpress.XtraGrid.GridControl grd_e;
		private DevExpress.XtraGrid.Views.Grid.GridView grdv_e;
