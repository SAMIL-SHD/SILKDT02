...
namespace DUTY1000
{
    public partial class rpt_2040 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rpt_2040 (string yymm, string part, DataTable ds)
        {
            InitializeComponent();
            xrLabel4.Text = yymm.Substring(0, 4) + "." + yymm.Substring(4, 2) + "월 Call대기";
            lb_part.Text = part;
