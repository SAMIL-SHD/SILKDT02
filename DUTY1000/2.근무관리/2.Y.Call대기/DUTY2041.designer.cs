namespace DUTY1000
{
    partial class duty2041
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(duty2041));
			...
			this.srTitle1.SRTitleTxt = "Call부서설정";
			...
			this.Text = "duty2041";
			this.Load += new System.EventHandler(this.duty2041_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.duty2041_KeyDown);
