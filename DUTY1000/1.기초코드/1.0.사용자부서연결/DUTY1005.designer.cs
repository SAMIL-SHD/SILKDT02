namespace DUTY1000
{
    partial class duty1005
    {
        ...
        private void InitializeComponent()
        {
			...
			this.grd_cmb1 = new DevExpress.XtraEditors.Repository.RepositoryItemComboBox();
			...
			((System.ComponentModel.ISupportInitialize)(this.grd_cmb1)).BeginInit();
			...
			this.srTitle1.SRTitleTxt = "사용자부서연결";
            ...
            this.grd_chk1,
            this.grd_cmb1});
			this.grd1.Size = new System.Drawing.Size(957, 564);
			...
			// grd_cmb1
			// 
			this.grd_cmb1.Appearance.Font = new System.Drawing.Font("맑은 고딕", 9F);
			this.grd_cmb1.Appearance.Options.UseFont = true;
			this.grd_cmb1.AppearanceDropDown.Font = new System.Drawing.Font("맑은 고딕", 9F);
			this.grd_cmb1.AppearanceDropDown.Options.UseFont = true;
			this.grd_cmb1.AutoHeight = false;
			this.grd_cmb1.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.grd_cmb1.Items.AddRange(new object[] {
            "",
            "부서관리권한",
            "전체관리권한"});
			this.grd_cmb1.Name = "grd_cmb1";
			this.grd_cmb1.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor;
			// 
			// gridColumn2
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.grd_cmb1)).EndInit();
		...
		private DevExpress.XtraEditors.Repository.RepositoryItemComboBox grd_cmb1;
	}
}
