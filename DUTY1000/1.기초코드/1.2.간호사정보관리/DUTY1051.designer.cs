namespace DUTY1000
{
    partial class duty1051
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(duty1051));
			...
			this.col_name.Caption = "직종명칭";
			this.col_name.FieldName = "JONGNAME";
			...
			this.srTitle1.SRTitleTxt = "간호사직종설정";
			...
			this.col_code.Caption = "직종코드";
			this.col_code.FieldName = "JONGCODE";
			...
			this.Text = "duty1051";
			this.Load += new System.EventHandler(this.duty1051_Load);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.duty1051_KeyDown);
